                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="bg-muted/50 border-b border-border">
                        ...
                        <th className="text-left p-4 font-semibold text-sm">Unit Price</th>
                        <th className="text-right p-4 font-semibold text-sm">Item Total</th>
                      </tr>
                    </thead>
                    <tbody>
                      {order.order_items.map((item, index) => (
                        <tr key={index} className="border-b border-border hover:bg-muted/30 transition-colors">
                          ...
                          <td className="p-4 text-sm font-medium">{item.product_name}</td>
                          <td className="p-4 text-sm font-medium">{item.quantity}</td>
                          <td className="p-4 text-sm">${item.price.toFixed(2)}</td>
                          <td className="p-4 text-sm text-right font-semibold">${(item.quantity * item.price).toFixed(2)}</td>
                        </tr>
                      ))}
                      <tr className="bg-muted/50 font-semibold">
                        <td colSpan={4} className="p-4 text-sm">Total</td>
                        <td className="p-4 text-sm text-right">${order.total_amount.toFixed(2)}</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
